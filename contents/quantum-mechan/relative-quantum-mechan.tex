...
\begin{proof}
    \begin{equation}
        ...
        =& \begin{pmatrix}
            ...
            0  &  (\bsigma \cdot \bA) (\bsigma \cdot (\bB) \\
           \end{pmatrix} \\
        =& \begin{pmatrix}
            \bA \cdot \bB + {\rm i} \bsigma \cdot (\bm{A} \times \bB)  &  0 \\
            0  &  \bA \cdot \bB + {\rm i} \bsigma \cdot (\bm{A} \times \bB) \\
           \end{pmatrix} \\
        =& \bA \cdot \bB + {\rm i} \bSigma (\bm{A} \times \bB)
        \end{aligned}
    \end{equation}
    最后一个等号的第一项其实是$\bm{I} \cdot (\bA \cdot \bB)$，$\bm{I}$是一个与
    $\bSigma$相同维度的单位矩阵。
\end{proof}
...
\begin{proof}
    ...
    \begin{equation}
        ...
        = \begin{pmatrix}
           ...
           \end{pmatrix} \\
    \end{equation}
    由以上两式可知$(\balpha\cdot\bA)(\bSigma\cdot\bB)=(\bSigma\cdot\bA)(\balpha\cdot\bB)$。
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \end{pmatrix} 
            + \begin{pmatrix}
                0 & {\rm i} \bsigma \cdot (\bm{A} \times \bB) \\
                {\rm i} \bsigma \cdot (\bm{A} \times \bB) & 0 \\
            \end{pmatrix} \\
            =& - r_5 \bA \cdot \bB + i \balpha \cdot (\bA \times \bB)
        \end{aligned}
    \end{equation}
    其中
    \begin{equation*}
...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            \left[ \frac{\bSigma\cdot\bmp}{|p|}, \hat{\bH} \right] =&
